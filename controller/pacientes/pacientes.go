...
func Adicionar(w http.ResponseWriter, r *http.Request) {
	...
	query := "INSERT INTO paciente (nome, email, senha, data_nascimento, hospital, carteira, role) VALUES(?,?,?,?,?,?,?)"
	...
	_, err = stmt.Exec(novoPaciente.Nome, novoPaciente.Email, novoPaciente.Senha, novoPaciente.DataNascimento, novoPaciente.Hospital, novoPaciente.Carteira, "p")
...
func Todos(w http.ResponseWriter, r *http.Request) {
	...
	query := "SELECT codigo, UPPER(nome) , UPPER(email) ,data_nascimento, hospital,carteira FROM paciente"
...
func Buscar(w http.ResponseWriter, r *http.Request) {
	...
	query := "SELECT codigo, UPPER(nome) , UPPER(email) ,data_nascimento, hospital,carteira FROM paciente WHERE nome LIKE ?"
...
func Alterar(w http.ResponseWriter, r *http.Request) {
	...
	stmt, err := DB.Prepare("UPDATE paciente SET nome = ? , email = ? , data_nascimento = ? , hospital = ? , carteira = ? WHERE codigo = ?")
	mensagemErro = "query_exec_erro"
	CheckErro(w, r, mensagemErro, err)

	stmt.Exec(paciente.Nome, paciente.Email, paciente.DataNascimento, paciente.Hospital, paciente.Carteira, paciente.Codigo)
